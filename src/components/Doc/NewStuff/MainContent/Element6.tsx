    ...
    <section id='e6' data-section className='py-14 doc-content-text border-b-[1px] lg:px-0 px-5'>
      ...
      <section id='e6.1' data-section className='pt-10 '>
        ...
        <p className='mt-8 mb-6'>
          ...
          <HighlightText content='transition process' clickToId='gt-T' />. This follow up point can also be an important evaluation metric for your program or institution, and can
          elucidate processes that might require change. It is important to implement accessible, youth-friendly follow-up methods which young people would be more likely to engage
          with (i.e., texting)
        </p>
        <Quote
          author='Youth'
